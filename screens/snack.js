...
const breakfast = ({navigation}) => {
  ...
  <View style={{flex:1}}>
     <Header/>
     <ScrollView>
<View style={{width:win.width,height:100,backgroundColor:'#ce6efa',alignItems:'center',justifyContent:'center'}}>
  <Text style={{fontSize:45,color:'#fff'}}>點心</Text>
</View>
   <View style={{width:win.width,height:400,backgroundColor:'#c987e8',alignItems:'center',marginTop:5}}>
...
<View style={{backgroundColor:'#ce6efa',height:win.width/4,width:win.width*0.495,marginTop:2,alignItems:'center',justifyContent:'center'}}>
